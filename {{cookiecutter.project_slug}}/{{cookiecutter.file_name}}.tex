...
\newcommand{\mainmatter}{
    \pagenumbering{roman}
    \setcounter{page}{1} % Abstract starts at page i
}
...
\begin{center}
\vspace*{1in}
{\Large \textsc{ {{cookiecutter.thesis_title}} }} \\
\vspace{0.5in}
...
\vspace*{1in}
\begin{center}
© Copyright by {{cookiecutter.author_name}}, {{cookiecutter.copyright_year}}. \\ 
All rights reserved.
\end{center}
...
\titlespacing*{\chapter}{0pt}{0.em}{1.5em}
